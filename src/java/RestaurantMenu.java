                ...
                throws ServletException, IOException
    {
            ...
            try {
                ...
                StringBuilder productbuilder = new StringBuilder();
                        ...
                        while(queue.next()){// While the next entry in the queue is not NULL... Respectively process this entry and...
                                //int id = queue.getInt("id");
                                //idbuilder.append(id + "<br>");
                                float pr = queue.getFloat("price");                // create a local float to store the current value associated with price field
                                String desc = queue.getString("description");      // create a local string to store the current value associated with description field
                                String prod = queue.getString("product");          // create a local string to store the current value associated with product field
